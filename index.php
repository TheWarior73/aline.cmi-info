...
<body>
    <header>
        <a href="">
            ...
            <span id="header_aline">Aline B.</span>
        </a>
        <nav>
            <ul>
    ...
    <main>
        <div id="bio">
            <div id="main">
                <div id="name">
                    <img src="img/luzTOH_450.png" alt="LuzTOH pfp">
                    <h1>
                        Hi, I'm Aline B.
                    </h1>
                </div>
                <div id="short">
                    ...
                    <p>A transfem into Computer Science <code id="bio-comment"></code></p>
                </div>
            </div>
            <div id="long_bio">
                <p>
                    I am a 18 yo student, studying <u>computer science</u> at Université Savoie Mont Blanc. I already have a background in CS with some projects of my own or during High School.
                </p>
                <p>
                    I usually prefer to do <u>backend work, for example with bots, data </u>... Sometimes I produce other work like this website among other projects.
                </p>
                <p>
                    I enjoy doing my own designs, but it does take a lot of time, this is one of the reasons that I do not do these often.
                </p>
            </div>
        </div>

        <h3>
            Here are some Infos about what I work with, my goals and contact :
        </h3>

        <div class="container">
            <div id="left-column">
                <div id="tools">
                    <h1>I work with this</h1>
                    ...
                    <div id="showcase">
                        <span id="icons">
                            ...
                            <a href="https://www.microsoft.com/en-us/software-download/windows11" id="ms-logo"> 
                                <figure>
                                    <svg role="img" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                        <title>Microsoft Windows</title>
                                        <path id="ms-red" d="M6,6h17v17H6V6z"></path>
                                        <path id="ms-green" d="M25.042,22.958V6H42v16.958H25.042z"></path>
                                        <path id="ms-blue" d="M6,25h17v17H6V25z"></path>
                                        <path id="ms-yellow" d="M25,42V25h17v17H25z"></path>
                                    </svg>
                                    <figcaption>
                                        MS Windows
                                    </figcaption>
                ...
                <div id="tools">
                    ...
                    <div id="showcase">
                        <span id="icons">
                            <a href="https://learn.microsoft.com/fr-fr/dotnet/csharp/tour-of-csharp/">
                                <figure>
                                    <title>CSharp</title>
                ...
                <div id="Accounts">
                    <h1>I have accounts over there</h1>
                    ...
                    <div id="showcase">
                        <span id="icons">
                            <a href="https://github.com/TheWarior73">
                                <figure>
                                    <title>Github</title>
                                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div id="showcase">
                        <span id="icons">
                            <a href="mailto:alinebellot73@gmail.com">
                                <figure>
                                    <title>Mail</title>
                                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="mailto:Ewen.Bellot@etu.univ-savoie.fr">
                                <figure>
                                    <title>Mail</title>
                                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M15.61 12c0 1.99-1.62 3.61-3.61 3.61-1.99 0-3.61-1.62-3.61-3.61 0-1.99 1.62-3.61 3.61-3.61 1.99 0 3.61 1.62 3.61 3.61M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12c2.424 0 4.761-.722 6.76-2.087l.034-.024-1.617-1.879-.027.017A9.494 9.494 0 0 1 12 21.54c-5.26 0-9.54-4.28-9.54-9.54 0-5.26 4.28-9.54 9.54-9.54 5.26 0 9.54 4.28 9.54 9.54a9.63 9.63 0 0 1-.225 2.05c-.301 1.239-1.169 1.618-1.82 1.568-.654-.053-1.42-.52-1.426-1.661V12A6.076 6.076 0 0 0 12 5.93 6.076 6.076 0 0 0 5.93 12 6.076 6.076 0 0 0 12 18.07a6.02 6.02 0 0 0 4.3-1.792 3.9 3.9 0 0 0 3.32 1.805c.874 0 1.74-.292 2.437-.821.719-.547 1.256-1.336 1.553-2.285.047-.154.135-.504.135-.507l.002-.013c.175-.76.253-1.52.253-2.457 0-6.617-5.383-12-12-12"></path>
            ...
            <div id="right-column">
                ...
                <div id="quick_links">
                    ...
                    <p> 
                        <a href="/USMB/COEFS/">
                            Calcul de moyennes Licence Info USMB «
                        </a>
                    </p>
                    <p>
                        <a href="/projects/perso/problem_solver/">
                            Problem Solver «
                        </a>
                    </p>
                </div>
